...
The c12 claim is not a full-rank claim.  The intended modular certificate has
two parts.
...
The Higgs-moduli conclusion uses an additional theorem outside this computation:
the relevant `H^22` relation is unique and lies in the invariant
Chern-degree-12 candidate space.  The modular JK computation supplies a
finite-field certificate for the candidate line; an exact relation requires a
separate rational reconstruction/exact-verification artifact.
